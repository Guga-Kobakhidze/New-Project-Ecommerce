  ...
  const products = [
    {
      ...
      description:
        "The Gildan Ultra Cotton T-Shirt is made from a substantial 6.0 oz. per centsq. yd. fabric constructed from 100% cotton, this classic fit preshunk jersey knit provides unmatched comfort with each wear. Featuring ataped neck and shoulder, and a seamless double-needle collar, and avialable in a range of colors, it offers it all in the ultimate head-turning package.",
      price: 140,
